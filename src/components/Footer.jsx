export default function Footer() {
  return (
    <p>
      ...
      <a href="https://github.com/shiba4life/fold_db/blob/mainline/docs/GOAL.md" target="_blank" rel="noreferrer">GOAL.md</a>
      <br />
      ...
      <br />
      <span className="dim">&copy; 2025-2026 Fold DB &mdash; Built in the open</span>
    </p>
  );
}
